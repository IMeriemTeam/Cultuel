...
import { ArticlesTrueComponent } from 'app/entities/articles-true/articles-true.component';
...
describe('Component Tests', () => {
    describe('ArticlesTrue Management Component', () => {
        let comp: ArticlesTrueComponent;
        let fixture: ComponentFixture<ArticlesTrueComponent>;
        let service: ArticlesTrueService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [CultuelTestModule],
                declarations: [ArticlesTrueComponent],
                providers: [
                    {
                ...
                .overrideTemplate(ArticlesTrueComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(ArticlesTrueComponent);
