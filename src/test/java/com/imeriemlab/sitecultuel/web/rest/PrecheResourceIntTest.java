...
public class PrecheResourceIntTest {
    ...
    @Autowired
    private PrecheMapper precheMapper;
    ...
    public void createPreche() throws Exception {
        ...
        // Create the Preche
        PrecheDTO precheDTO = precheMapper.toDto(preche);
        restPrecheMockMvc.perform(post("/api/preches")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(precheDTO)))
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(PrecheDTO.class);
        PrecheDTO precheDTO1 = new PrecheDTO();
        precheDTO1.setId(1L);
        PrecheDTO precheDTO2 = new PrecheDTO();
        assertThat(precheDTO1).isNotEqualTo(precheDTO2);
        precheDTO2.setId(precheDTO1.getId());
        assertThat(precheDTO1).isEqualTo(precheDTO2);
        precheDTO2.setId(2L);
        assertThat(precheDTO1).isNotEqualTo(precheDTO2);
        precheDTO1.setId(null);
        assertThat(precheDTO1).isNotEqualTo(precheDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(precheMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(precheMapper.fromId(null)).isNull();
    }
}
